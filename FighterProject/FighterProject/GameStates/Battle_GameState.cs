...
namespace FighterProject.GameStates {
    class Battle_GameState : GameState {
        ...
        public override void LoadContent(ContentManager content) {
            ...
            Player player1 = new Player(1, new ShadowMan(content.Load<Texture2D>(ShadowMan.SpriteSheet), true), Battlefield.Player1StartingPos);
            Player player2 = new Player(2, new TestChar(content.Load<Texture2D>(TestChar.SpriteSheet), false), Battlefield.Player2StartingPos);
